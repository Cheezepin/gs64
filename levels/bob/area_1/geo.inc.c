...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_battle_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, bob_dl_battle_cutout_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, bob_dl_cutout_mesh),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_nocol_mesh),
