...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_VERIO,                   verio_geo),
    LOAD_MODEL_FROM_GEO(MODEL_JURIO,                   jurio_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MERIO,                   merio_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_POINTER,                 pointer_geo),
    LOAD_MODEL_FROM_GEO(MODEL_HALO,                    halo_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LIFTROCK,                liftrock_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PLANT,                   plant_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TORNADO,                 tornado_psy_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LEAF,                    leaf_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GROWTH,                  growth_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SPIRE,                   spire_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GLACIER,                 glacier_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GROUND,                  ground_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PUDDLE,                  puddle_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FROST_SPIRE,             frost_spire_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CHEST,                   chest_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PORKY,                   porky_geo),
    FREE_LEVEL_POOL(),
