Lights1 ccm_dl_sm64_material_lights = gdSPDefLights1(
	0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Vtx ccm_dl_Cube_mesh_vtx_0[24] = {
...
Gfx ccm_dl_Cube_mesh_tri_0[] = {
	gsSPVertex(ccm_dl_Cube_mesh_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(ccm_dl_Cube_mesh_vtx_0 + 16, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_ccm_dl_sm64_material[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(ccm_dl_sm64_material_lights),
	gsSPEndDisplayList(),
};

Gfx ccm_dl_Cube_mesh[] = {
	gsSPDisplayList(mat_ccm_dl_sm64_material),
	gsSPDisplayList(ccm_dl_Cube_mesh_tri_0),
	gsSPEndDisplayList(),
};
